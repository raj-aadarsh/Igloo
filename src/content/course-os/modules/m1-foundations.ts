    ...
    },
    {
      ...
      blocks: [
        ...
        { type: 'keyterms', terms: [
          ...
          { term: 'Real-time (RTOS)', def: 'Guarantees responses within strict deadlines (medical, avionics, embedded).' },
          { term: 'Distributed', def: 'Many networked machines presented as one system.' },
        ] },
        { type: 'callout', variant: 'tip', text: 'Don’t confuse **multiprogramming** (one CPU, overlap by switching during I/O waits), **multitasking** (one CPU, fast time-slicing for interactivity), and **multiprocessing** (multiple CPUs, real parallelism).' },
      ],
    },
  ],
  quiz: [
