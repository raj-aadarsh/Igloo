...
| 04 | **Computer Networks** | How the internet works — OSI/TCP-IP layers, IP & live subnetting, the data link layer, TCP/UDP, DNS & HTTP — with interactive diagrams (in progress). |
| 05 | **Coming soon** | More courses on the way. |
